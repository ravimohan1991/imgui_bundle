...
execute_process(
  COMMAND "/usr/bin/git" show-ref "imgui_bundle"
  WORKING_DIRECTORY "/Users/cowboy/imgui_bundle/KarmaiOSLightHouse/_deps/imgui_test_engine-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "imgui_bundle")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("imgui_bundle" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/imgui_bundle")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/cowboy/imgui_bundle/KarmaiOSLightHouse/_deps/imgui_test_engine-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/cowboy/imgui_bundle/KarmaiOSLightHouse/_deps/imgui_test_engine-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
