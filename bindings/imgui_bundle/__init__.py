...
def _has_submodule(submodule_name):
...
if _has_submodule("imgui"):
    ...
    __all__.extend(["ImVec2", "ImVec4", "ImColor", "FLT_MIN", "FLT_MAX"])
if _has_submodule("hello_imgui"):
...
if _has_submodule("immapp_cpp"):  # immapp is a Python wrapper around immapp_cpp
...
__all__.extend(["IM_COL32", "imgui_ctx", "imgui_node_editor_ctx"])
try:
